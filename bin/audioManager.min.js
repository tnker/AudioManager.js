(function(f){function k(){}function j(a,d,b){this.context=a;this.urlList=d;this.onload=b;this.bufferList=[];this.loadCount=0}function g(a){a=a||{};l||console.warn("not support user media");void 0===a.autoLoop&&(a.autoLoop=!0);this.context=null;this.sources={};this.analyser={};this.state={};this.fps=a.fps||24;this.autoLooop=!!a.autoLoop;this.ffSize=a.ffSize||2048;this.onEnterFrame=a.onEnterFrame||h;this.onInit=a.onInit||h;this.onMicInitSuccess=a.onMicInitSuccess||h;this.onMicInitFaild=a.onMicInitFaild||
